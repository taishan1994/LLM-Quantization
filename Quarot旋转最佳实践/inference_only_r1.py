...
if __name__ == '__main__':
    ...
    model.save_pretrained("/data/gongoubo/checkpoints/Qwen/Qwen3-0.6B-merge-norm")
    tokenizer.save_pretrained("/data/gongoubo/checkpoints/Qwen/Qwen3-0.6B-merge-norm")
