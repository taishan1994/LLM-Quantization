...
class Qwen3Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        query_states = self.q_norm(self.q_proj(hidden_states, R1).view(hidden_shape))
        key_states = self.k_norm(self.k_proj(hidden_states, R1).view(hidden_shape))
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        if R1 is not None:
            ...
            inputs_embeds = (inputs_embeds.to(torch.float32) @ R1.to(torch.float32)).to(
                dtype
            )
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        if self.R1 is not None:
            ...
            hidden_states = (
                    hidden_states.to(torch.float32) @ self.R1.weight.T.to(torch.float32)
            ).to(dtype)
