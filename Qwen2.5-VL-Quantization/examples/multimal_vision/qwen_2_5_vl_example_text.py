...
print("开始加载数据集！！")
data = load_dataset("/ms/FM/chenshuailin/data/mit-han-lab___pile-val-backup/", split="validation[:512]")
# ds = data["validation"]
ds = data
...
ds = ds.map(preprocess_and_tokenize, remove_columns=ds.column_names, num_proc=32)
...
SAVE_DIR =  "/ms/FM/gongoubo/checkpoints/data/Qwen2___5-VL-7B-Instruct-text"+ "-W8A8"
